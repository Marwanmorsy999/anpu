...
import (
	...
	"github.com/Marwanmorsy999/anpu/internal/actuator"
	"github.com/Marwanmorsy999/anpu/internal/api"
	"github.com/Marwanmorsy999/anpu/internal/apiconsole"
	"github.com/Marwanmorsy999/anpu/internal/apiversion"
	"github.com/Marwanmorsy999/anpu/internal/archiveurls"
	"github.com/Marwanmorsy999/anpu/internal/authz"
	"github.com/Marwanmorsy999/anpu/internal/axfrplus"
	"github.com/Marwanmorsy999/anpu/internal/backup"
	"github.com/Marwanmorsy999/anpu/internal/backupplus"
	"github.com/Marwanmorsy999/anpu/internal/bgp"
	"github.com/Marwanmorsy999/anpu/internal/brokenlink"
	"github.com/Marwanmorsy999/anpu/internal/bucket"
	"github.com/Marwanmorsy999/anpu/internal/cachedeception"
	"github.com/Marwanmorsy999/anpu/internal/certhistory"
	"github.com/Marwanmorsy999/anpu/internal/certsan"
	"github.com/Marwanmorsy999/anpu/internal/clickjack"
	"github.com/Marwanmorsy999/anpu/internal/codesecrets"
	"github.com/Marwanmorsy999/anpu/internal/commentminer"
	"github.com/Marwanmorsy999/anpu/internal/cookieprefix"
	"github.com/Marwanmorsy999/anpu/internal/cors"
	"github.com/Marwanmorsy999/anpu/internal/corsplus"
	"github.com/Marwanmorsy999/anpu/internal/csprecon"
	"github.com/Marwanmorsy999/anpu/internal/csrf"
	"github.com/Marwanmorsy999/anpu/internal/cswsh"
	"github.com/Marwanmorsy999/anpu/internal/cvepack"
	"github.com/Marwanmorsy999/anpu/internal/debugmethods"
	"github.com/Marwanmorsy999/anpu/internal/debugpages"
	"github.com/Marwanmorsy999/anpu/internal/deps"
	"github.com/Marwanmorsy999/anpu/internal/difforacle"
	"github.com/Marwanmorsy999/anpu/internal/dirs"
	"github.com/Marwanmorsy999/anpu/internal/dnsaudit"
	"github.com/Marwanmorsy999/anpu/internal/dnsintel"
	"github.com/Marwanmorsy999/anpu/internal/doh"
	"github.com/Marwanmorsy999/anpu/internal/emailauth"
	"github.com/Marwanmorsy999/anpu/internal/emailharv"
	"github.com/Marwanmorsy999/anpu/internal/encodepoly"
	"github.com/Marwanmorsy999/anpu/internal/endpoints"
	"github.com/Marwanmorsy999/anpu/internal/exposedconfig"
	"github.com/Marwanmorsy999/anpu/internal/exposedgit"
	"github.com/Marwanmorsy999/anpu/internal/favicon"
	"github.com/Marwanmorsy999/anpu/internal/faviconplus"
	"github.com/Marwanmorsy999/anpu/internal/forbiddenbypass"
	"github.com/Marwanmorsy999/anpu/internal/gfclassify"
	"github.com/Marwanmorsy999/anpu/internal/graphqlfp"
	"github.com/Marwanmorsy999/anpu/internal/graphqlschema"
	"github.com/Marwanmorsy999/anpu/internal/h2fp"
	"github.com/Marwanmorsy999/anpu/internal/h2smuggle"
	"github.com/Marwanmorsy999/anpu/internal/headers"
	"github.com/Marwanmorsy999/anpu/internal/hiddenparams"
	anpuhttp "github.com/Marwanmorsy999/anpu/internal/http"
	"github.com/Marwanmorsy999/anpu/internal/integrations"
	"github.com/Marwanmorsy999/anpu/internal/ipintel"
	"github.com/Marwanmorsy999/anpu/internal/jsluice"
	"github.com/Marwanmorsy999/anpu/internal/jssecrets"
	"github.com/Marwanmorsy999/anpu/internal/jwtconfirm"
	"github.com/Marwanmorsy999/anpu/internal/jwtplus"
	"github.com/Marwanmorsy999/anpu/internal/leak"
	"github.com/Marwanmorsy999/anpu/internal/lfipack"
	"github.com/Marwanmorsy999/anpu/internal/methods"
	"github.com/Marwanmorsy999/anpu/internal/nosqlexpand"
	"github.com/Marwanmorsy999/anpu/internal/nsecwalk"
	"github.com/Marwanmorsy999/anpu/internal/oauth"
	"github.com/Marwanmorsy999/anpu/internal/oauthpack"
	"github.com/Marwanmorsy999/anpu/internal/originip"
	"github.com/Marwanmorsy999/anpu/internal/params"
	"github.com/Marwanmorsy999/anpu/internal/policyheaders"
	"github.com/Marwanmorsy999/anpu/internal/portscan"
	"github.com/Marwanmorsy999/anpu/internal/postmessage"
	"github.com/Marwanmorsy999/anpu/internal/ppollute"
	"github.com/Marwanmorsy999/anpu/internal/rdap"
	"github.com/Marwanmorsy999/anpu/internal/recon"
	"github.com/Marwanmorsy999/anpu/internal/redirectpack"
	"github.com/Marwanmorsy999/anpu/internal/saml"
	"github.com/Marwanmorsy999/anpu/internal/scanner"
	"github.com/Marwanmorsy999/anpu/internal/secrets"
	"github.com/Marwanmorsy999/anpu/internal/soap"
	"github.com/Marwanmorsy999/anpu/internal/socialhijack"
	"github.com/Marwanmorsy999/anpu/internal/sri"
	"github.com/Marwanmorsy999/anpu/internal/sstiexpand"
	"github.com/Marwanmorsy999/anpu/internal/subdomains"
	"github.com/Marwanmorsy999/anpu/internal/subpermute"
	"github.com/Marwanmorsy999/anpu/internal/swscope"
	"github.com/Marwanmorsy999/anpu/internal/takeover"
	"github.com/Marwanmorsy999/anpu/internal/takeoverplus"
	"github.com/Marwanmorsy999/anpu/internal/technology"
	"github.com/Marwanmorsy999/anpu/internal/timeoracle"
	"github.com/Marwanmorsy999/anpu/internal/tls"
	"github.com/Marwanmorsy999/anpu/internal/verbtamper"
	"github.com/Marwanmorsy999/anpu/internal/vhost"
	"github.com/Marwanmorsy999/anpu/internal/wafdetect"
